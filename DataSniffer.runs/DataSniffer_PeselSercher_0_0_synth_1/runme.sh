...
HD_PWD='C:/git/SDPU/DataSniffer/DataSniffer.runs/DataSniffer_PeselSercher_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataSniffer_PeselSercher_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataSniffer_PeselSercher_0_0.tcl
