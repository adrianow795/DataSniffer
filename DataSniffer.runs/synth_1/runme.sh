...
HD_PWD='C:/git/SDPU/DataSniffer/DataSniffer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PeselSearcher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PeselSearcher.tcl
