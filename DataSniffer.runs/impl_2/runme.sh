...
HD_PWD='C:/git/SDPU/DataSniffer/DataSniffer.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log DataSniffer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DataSniffer_wrapper.tcl -notrace
