...
HD_PWD='C:/git/SDPU/DataSniffer/DataSniffer.runs/DataSniffer'
cd "$HD_PWD"
...
EAStep vivado -log DataSniffer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataSniffer_wrapper.tcl
