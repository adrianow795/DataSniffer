...
HD_PWD='C:/git/SDPU/DataSniffer/DataSniffer.runs/DataSniffer_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataSniffer_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataSniffer_processing_system7_0_0.tcl
