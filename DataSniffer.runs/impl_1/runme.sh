...
HD_PWD='C:/git/SDPU/DataSniffer/DataSniffer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PeselSearcher.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PeselSearcher.tcl -notrace
